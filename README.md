...
<h4 align="center">Source code for {name}, a {thing}.</h4>
...
1. Clone this repository: `git clone https://github.com/xHyroM/{NAME}.git`
...
This project is licensed under the [Apache-2.0 License](LICENSE)|[MIT License](LICENSE)|[MPL-2.0 License](LICENSE).
